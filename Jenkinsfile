        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/dtcaugust2021-211/web-server:v2.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
                ...
                echo "gcr.io/dtcaugust2021-211/web-server:2.${env.BUILD_ID}"
                sh "kubectl set image deployment/demo-ui demo-ui=gcr.io/dtcaugust2021-211/web-server:v2.${env.BUILD_ID} --record"
            }
        }
    }
}
